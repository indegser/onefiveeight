...
- Preview evidence or screenshots when available
...
## Completion
- Stop after recording structured findings, section scores, profile assessment, gating flags, approval status, and recommended next steps.
