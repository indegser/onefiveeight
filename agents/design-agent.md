...
- Output builder constraints and review targets, not just screen descriptions.

## Required Output Shape
- Must conform to `./.ai/schemas/design.schema.json`

## Completion
- Stop after producing screens, flows, UX rules, state handling, component map, design-rule-engine references, builder constraints, review targets, and approval flags.
